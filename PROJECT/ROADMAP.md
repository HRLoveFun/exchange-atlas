...
- **2026-09-01 · 剖面视觉迭代 · 机制核心面板 + 透视开关**（[ADR-054]）— 「交易机制」七项从主图下方收进主图中心一块固定 628×276、垂直居中于零轴的 `foreignObject` 面板；面板右上角 `◐/●` 透视开关露出被盖的零轴/熔断线/走廊；纯前端两文件、`docs/data/` 零 diff

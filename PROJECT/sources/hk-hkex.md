...
- `hkex.com.hk`（2026-09-05 补充登记，任务四族A：HKSCC 现货保证金制度，沿用既有域名条目） | 官方 | en | curl 常规 UA 200
  ...
  - 2026-09-05 新增（任务四收尾第29条，沿用 `hkex.com.hk` 既有域名条目）: Getting Started FAQ 英文版（HKEX 发展历史/SFC 与 HKEX 监管职能分工/海外投资者参与市场三问的官方答复——overview.history、self_regulatory_org、foreign_access_channel 出处；服务端渲染，curl 可抓正文）: https://www.hkex.com.hk/Global/Exchange/FAQ/Getting-Started?sc_lang=en（HTTP 200，532KB）

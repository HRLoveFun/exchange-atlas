...
- 2026-09-05 · 任务三附·剖面现货/衍生品业务线切换（渲染层）完成（[ADR-PENDING-td-business-line-toggle]）——10 家所剖面加二段业务线切换，切衍生品整体换数据源到 `*.derivatives.*`、诚实三态缺口留空，删欠账 banner，纯前端零 data diff。Phase 3 六模块渲染层 + 本切换均已落地。

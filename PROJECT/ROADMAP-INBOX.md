...
- 2026-09-04 · 并行 worktree 防失序四道护栏（§一 单写者 + INBOX + 合并纪律 + ADR 台账），`selfcheck` 24→43 · [ADR-069] · worktree-antidisorder
  - 折叠动作：①「最近完成」加此条、裁到 3 条；②「下一步」无需改（本条不产生新迭代点，已知局限见 §三详版）；③ 折完删除本便签。
